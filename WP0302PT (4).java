...
//		}
	...
	*/
	public void backupdesctext(String meid)throws Throwable {
	
		//搜尋資料
		String sql="SELECT markname,picchk,marktype,markpic,markmeid,markappyid,markregid,relchk FROM wptmapply WHERE meid ='"+ meid+"'";
